...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_mx_expenses_amount = fields.Float(
        "Limit amount for expenses",
        readonly=False,
        related="company_id.l10n_mx_expenses_amount",
        help="After of this amount will be notified to the employees indicated.",
    )
    ...
    l10n_mx_edi_fuel_code_sat_ids = fields.Many2many(
        "product.unspsc.code", "SAT fuel codes", readonly=False, related="company_id.l10n_mx_edi_fuel_code_sat_ids"
    )
