...
class L10nMxEdiMergeExpense(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if expense.l10n_mx_edi_invoice_id:
            raise UserError(_("This expense cannot be merged, because already has an invoice related."))
    ...
    expense_id = fields.Many2one("hr.expense", "Destination Expense", help="Destination expense after merge.")
    expense_ids = fields.Many2many("hr.expense", string="Expenses", help="Expenses to merge with the current.")
    ...
    def action_merge(self):
        ...
        src.message_post_with_view(
            "l10n_mx_edi_hr_expense.hr_expense_merge", values={"self": src, "origin": self.expense_id}
        )
